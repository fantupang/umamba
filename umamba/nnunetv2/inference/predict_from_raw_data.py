...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset002_Heart/nnUNetTrainerUMambaBot__nnUNetPlans__3d_fullres'),
        use_folds=(0, ),
        checkpoint_name='checkpoint_best.pth',
    )
    predictor.predict_from_files(join(nnUNet_raw, 'Dataset002_Heart/imagesTs'),
                                 join(nnUNet_raw, 'Dataset002_Heart/imagesTs_predlowres'),
    ...
    img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset002_Heart/imagesTr/la_003_0000.nii.gz')])
